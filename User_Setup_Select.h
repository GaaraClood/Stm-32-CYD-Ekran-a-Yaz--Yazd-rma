...
// ESP32 TENSTAR 2432S028 240*320 2.8 inch TFT Display Setup
// This setup is for ESP32 with ILI9341 240x320 TFT display

#define USER_SETUP_ID 201

// Driver selection
#define ILI9341_2_DRIVER     // Alternative ILI9341 driver, this can be slower but may work better with some TFT modules

// Display size
#define TFT_WIDTH  320
#define TFT_HEIGHT 240

// ESP32 TENSTAR 2432S028 pin connections
#define TFT_MISO 12  // Automatically assigned if not defined
#define TFT_MOSI 13  // SDA (Serial Data) pin
#define TFT_SCLK 14  // SCL (Serial Clock) pin
#define TFT_CS   15  // Chip select control pin
#define TFT_DC   2   // Data Command control pin
#define TFT_RST  -1  // Reset pin (could connect to RST pin but not used here)
#define TFT_BL   21  // LED back-light control pin

// Backlight control
#define TFT_BACKLIGHT_ON HIGH  // Level to turn ON back-light (HIGH or LOW)

// Touch screen chip select pin (if using touch)
#define TOUCH_CS 33     // Chip select pin for XPT2046 touch controller
...
// Optional: Uncomment if you want to use specific color order
